...
#ifndef GAME_CLIENT_COMPONENTS_FEX_FEXBINDWHEEL_H
#define GAME_CLIENT_COMPONENTS_FEX_FEXBINDWHEEL_H
#include <game/client/component.h>


#define BINDWHEEL_FILE "fex_bindwheel.cfg"
...
class CBindWheel : public CComponent
{
	...
	IOHANDLE m_BindwheelFile = nullptr;
