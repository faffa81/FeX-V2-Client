...
public:
	...
	void RenderGameTileOutlines(CTile *pTiles, int w, int h, float Scale, int TileType, float Alpha) const;

	void RenderTeleOutlines(CTile *pTiles, CTeleTile *pTele, int w, int h, float Scale, float Alpha) const;
